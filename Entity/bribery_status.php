...
class bribery_status
{
    ...
    public function __construct($bid, &$response)
    {
        ...
        if ($link) {
            $sql[0] = "SELECT b.uid, b.msg, b.val, b.type, b.num, b.ptime, u.`name` FROM bribery AS b INNER JOIN `user` AS u ON b.uid = u.uid WHERE b.bid = '" . $bid . "';";
